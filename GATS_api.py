...
def assemble_response_json(df):
    ...
    response_dict = {
        "state" : {"census_exports_release_dates" : max_year_and_month},
        "insert" : {"census_exports_release_dates" : inserts},
        "schema" : {"census_exports_release_dates" : {"primary_key" : ["statistical_year_month"]}},
        "hasMore" : False
    }
