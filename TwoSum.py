...
class Solution:
    ...
    def twoSum(self, nums, target):
        permute_list = []                                              #create empty array for combinations from nums
        for i in range(0, len(nums)):                   
            ...
            for j in compare_list:
                ...
                if num + j == target and idx_pair not in permute_list: #if pair sum equals target and is not in list, append
